    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        downloadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String apiUrl = getConfigValue(getApplicationContext(), "api_url");
                downloadFile(apiUrl+"/test.apk", "test.apk", MainActivity.this, Environment.DIRECTORY_DOWNLOADS);
            }
        });
        ...
        downloadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                // Change the text when the button is clicked
                log.setText("Installing Files");
                try {
                    installPackage(Environment.DIRECTORY_DOWNLOADS+"test.apk");
                } catch (IOException e) {
